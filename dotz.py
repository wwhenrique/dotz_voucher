...
class Dataframe:
    ...
    def gerar_arquivo_excel(self, produtos):
        ...
        writer = pd.ExcelWriter('dotz_vouchers.xlsx', engine='xlsxwriter')

        #armazena os dados na planilha
        df.to_excel(writer, sheet_name='Dotz', index=False)
...
excel = Dataframe()
excel.gerar_arquivo_excel(dados)